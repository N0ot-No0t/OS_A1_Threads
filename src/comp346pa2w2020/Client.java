...
//             }
    ...
    public void run()
    {
        ...
        sendClientStartTime = currentTimeMillis();
        receiveClientStartTime = currentTimeMillis();
        ...
        if (clientOperation.equals("sending")) {
            ...
            sendClientEndTime = currentTimeMillis();
            ...
            receiveClientEndTime = currentTimeMillis();
