...
public class Server extends Thread {
    ...
    {   int accIndex;             	/* Index position of account to update */
        ...
        //System.out.println("****** Server Thread status 1: "+getServerThreadRunningStatus1() + " 2: "+getServerThreadRunningStatus2());
...
//                	 }
    ...
    {   Transactions trans = new Transactions();
        ...
        System.out.println("\n DEBUG : Server.run() - starting server thread " + getServerThreadId() + ". Server status: " + Network.getServerConnectionStatus());
        ...
        while (!Network.getClientConnectionStatus().equals("connected")) { Thread.yield(); }
        ...
        while (!getServerThreadRunningStatus1().equals("terminated") || !getServerThreadRunningStatus2().equals("terminated")) Thread.yield();
